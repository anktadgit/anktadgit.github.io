...
var CountUp = {
  ...
  init: function() {
    ...
    countFromSec = new Date("May 26, 1988 22:57:00 UTC").getTime();
    var nowSec = new Date(),
        countFromSec = new Date(countFromSec),
        timeDifferenceSec = (nowSec - countFromSec);
  ...
  count: function() {
    ...
    var that    = this,
        ...
        $sec_4  = this.$.seconds.eq(3),
        $sec_5  = this.$.seconds.eq(4),
        $sec_6  = this.$.seconds.eq(5),
        $sec_7  = this.$.seconds.eq(6),
        $sec_8  = this.$.seconds.eq(7),
        $sec_9  = this.$.seconds.eq(8);
